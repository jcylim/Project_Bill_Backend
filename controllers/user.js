...
exports.hasAuthorization = (req, res, next) => {
    let isRightUser = req.profile && req.auth && req.profile._id == req.auth._id;
    let isAdmin = req.auth && (req.auth.company === String(req.company._id) && req.auth.role === "admin");

    const authorized = isRightUser || isAdmin;
...
exports.removeUser = (req, res, next) => {
    ...
    user.remove((err, user) => {
        ...
        res.json({ message: 'User removed from company and deleted successfully' });
    });
